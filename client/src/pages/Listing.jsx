        ...
        <main>
            ...
            {listing && !loading && !error && (
                <div>
                    ...
                    {copied && (
                        <p className='fixed top-[23%] right-[5%] rounded-md bg-slate-100 p-2 z-10'>
                            Link copied!
                        </p>
                    )}
                    ...
                    <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
                        ...
                        <ul className="flex text-green-900 font-semibold text-sm flex-wrap items-center gap-4 sm:gap-6">
